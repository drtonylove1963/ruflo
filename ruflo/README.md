...
| 🔬 **MetaHarness** ([ADR-150](https://github.com/ruvnet/ruflo/blob/main/v3/docs/adr/ADR-150-metaharness-integration-surfaces.md)) | 10 `ruflo metaharness *` subcommands + 9 MCP tools — harness readiness scoring, MCP security scanning, threat modeling, composite audits, ADR-152 §3.1 genome similarity, one-command drift detection — plus `ruflo eject` to lift any ruflo project into a renamed standalone harness. Optional dep, graceful degradation. See [user guide](https://github.com/ruvnet/ruflo/blob/main/docs/metaharness-user-guide.md) |
...
| **[MetaHarness Guide](https://github.com/ruvnet/ruflo/blob/main/docs/metaharness-user-guide.md)** | Deep guide to the 10 `ruflo metaharness *` subcommands + 9 MCP tools + ADR-152 §3.1 similarity + `ruflo eject`. The *audit-the-harness* doc. |
